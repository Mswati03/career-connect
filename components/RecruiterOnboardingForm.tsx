    ...
    <form>
      <div className="space-y-12">
        <div className="border-b border-gray-900/10 pb-12">
          <h2 className="text-base font-semibold leading-7 text-gray-900">Employer Profile</h2>
          <p className="mt-1 text-sm leading-6 text-gray-600">
            Provide your company details and contact information to post job opportunities.
          </p>
        ...
        <div className="border-b border-gray-900/10 pb-12">
          ...
          <p className="mt-1 text-sm leading-6 text-gray-600">Provide your contact details for account management.</p>
